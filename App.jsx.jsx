...
const RECENT_NEWS = {
  "adam randall": "BAL rookie RB, 2026 fifth round out of Clemson, being built as a JOKER under new OC Declan Doyle: fullback, tight end, slot and flexed outside, plus learning NFL pass protection. He led the team with 13 touches in the Aug 15 2026 preseason debut vs PHI (12 carries, 46 yards, a rushing TD, 1 catch on 2 targets) and the staff has kept feeding him run-heavy work since, deliberately outside his college comfort zone, to prepare him for a receiving role in space. He sits behind Derrick Henry and Justice Hill and is competing with Rasheen Ali for the RB3 job. CAVEAT: 3.8 yards per carry, and beat reporting flagged indecisive running on those reps.",
...
const SITUATIONS = {
  "adam randall": { verdict: "dart", trend: "rising", trendNote: "BAL JOKER ROOKIE, fifth round 2026 out of Clemson (updated Aug 30 2026). New OC Declan Doyle is building him as a multi-position piece: fullback, tight end, slot and flexed outside, which is a ROLE description rather than a depth-chart position. He led Baltimore with 13 touches in the Aug 15 preseason debut vs PHI, 12 carries for 46 yards with a rushing touchdown, and the staff has kept the run-heavy assignments coming to stretch him ahead of a receiving role in space. THE DEPTH CHART IS THE CONSTRAINT: Derrick Henry and Justice Hill are ahead of him and Rasheen Ali is competing for the same RB3 job, so there is no standalone weekly volume here at full health. What the price buys is the Henry contingency plus a gadget role that can spike without it. STACK CAUTION SPECIFIC TO THIS APP: he is a rookie with no prior NFL season, so he clears neither the Elite Receiving Back nor the Real Receiving Role tier and earns NO receiving-back stack credit. Grade a Lamar loop containing him as QB plus its pass catchers, and treat Randall as a same-team dart on top. Baltimore W17 at CIN is the strongest environment of his three playoff weeks. Confidence SPECULATIVE: gadget usage is the least projectable role in football, and 3.8 yards per carry with reporting on indecisive running is the honest counterweight to the camp buzz.", situationFlags: ["role_dependent", "scheme_fit"], riskFlags: ["depth_chart_competition"] },
