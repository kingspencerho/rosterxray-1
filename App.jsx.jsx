...
const RECENT_NEWS = {
  ...
  "charlie kolar": "LAC — signed a 3yr/$24.3M deal on Mar 10 2026 after four seasons in Baltimore, making him the highest-paid blocking tight end in NFL history (added Aug 23 2026). He is TE3 behind Oronde Gadsden and David Njoku and projects to lead the room in inline snaps, which is exactly what the contract bought: 6th in PFF run block grade (71.5) and 9th in total offense grade (78.7) among tight ends with 400+ snaps in 2025. PRICE THE ROLE, NOT THE CONTRACT — his career high is 10 receptions for 142 yards and 2 touchdowns, set in 2025, and Jim Harbaugh with new OC Mike McDaniel projects heavy 12 personnel where Kolar blocks rather than runs routes. For fantasy the useful signal points at the backfield: he is on the field to open lanes for Omarion Hampton. LAC playoff slate: W15 vs SF, W16 @MIA, W17 vs KC.",
...
const SITUATIONS = {
  ...
  "charlie kolar": { verdict: "fade", trend: "stable", trendNote: "LAC TE3 by depth chart and the highest-paid BLOCKING tight end in NFL history — 3yr/$24.3M signed Mar 10 2026. Both halves of that are true at once and they point the same way for fantasy. He sits behind Oronde Gadsden and David Njoku but projects to lead the room in INLINE snaps, because what Los Angeles paid for is run blocking: among tight ends with 400+ snaps in 2025 he graded 6th in PFF run block (71.5) and 9th in total offense (78.7). The receiving ceiling is the constraint. A CAREER HIGH of 10 catches for 142 yards and 2 TDs in 2025 is the whole body of evidence, and Jim Harbaugh with new OC Mike McDaniel points to heavy 12 personnel where Kolar functions as a sixth lineman. TEXTBOOK ROLE CEILING MISMATCH (Lens 1): draft capital is premium and role clarity is high, and both point AWAY from fantasy relevance rather than toward it. THE REAL READ-THROUGH IS OMARION HAMPTON — Kolar is on the field to open lanes for him, so treat this signing as a bull input on the LAC backfield rather than on the tight end.", situationFlags: ["scheme_fit"], riskFlags: ["role_ceiling_mismatch"] },
