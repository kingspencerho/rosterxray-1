...
const SITUATIONS = {
  ...
  "charlie kolar": { verdict: "DART", trend: "rising", trendNote: "LAC's 11-PERSONNEL TIGHT END, which is the every-down job (updated Aug 23 2026). On the Chargers' two first-team drives in preseason Week 2 he took EVERY snap in 11 personnel; he and David Njoku share the field in 12, and Njoku out-snaps him in 21. He also rested with the starters in the preseason opener while Oronde Gadsden played with the backups. THE DEPTH CHART SAYS TE3 AND THE SNAPS SAY OTHERWISE — grade the usage. He is the best blocker in the room on a 3yr/$24.3M deal (highest-paid blocking TE in NFL history) at 6th in PFF run block among TEs with 400+ snaps, and that is what keeps him on the field for three downs rather than what limits him to two. THE COLLEGE PROFILE IS A RECEIVER'S: 168-2181-23 at Iowa State, every school TE record, the only three-time All-American in program history and three straight First Team All-Big 12 seasons. His 10-catch NFL career high was set as the third option behind Mark Andrews and Isaiah Likely, so it measures Baltimore's pecking order rather than his hands. THE BET IS SNAPS BEFORE TARGETS: routes run is the prerequisite and he now has evidence of it; the target share is the open question, with Njoku and Gadsden both live and Harbaugh run-heavy. Per Lens 4 this is preseason Week 2, so it is scheme evaluation ahead of role confirmation — re-check the Week 3 snap split. Free at ADP, and LAC grades Good / Smash / Hard at TE across W15-17.", situationFlags: ["breakout_profile", "scheme_fit"], riskFlags: ["depth_chart_competition"] },
