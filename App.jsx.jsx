...
const SITUATIONS = {
  ...
  "ashton jeanty": { verdict: "TARGET", trend: "falling", trendNote: "INJURED, AND THE SEVERITY IS UNKNOWN (updated Aug 23 2026). He ran a route in a team period, dove for a low throw from Kirk Cousins, landed awkwardly and stayed down; trainers helped him off and he could not put pressure on his right leg. Las Vegas has announced no diagnosis, no MRI result and no timetable. TREAT ANY TIMELINE AS UNVERIFIED UNTIL THE TEAM CONFIRMS ONE — the mechanism and the inability to bear weight are the only hard facts, and they are consistent with outcomes ranging from a sprain to something season-ending. Rookie Mike Washington Jr. took the remaining first-team reps and had been alternating starting reps with Jeanty before this. The workhorse thesis was sound on role and is now entirely gated on the medical report. Re-check before any draft that has not closed.", situationFlags: ["breakout_profile"], riskFlags: ["injury_history"] },
