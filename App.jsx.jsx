...
const SITUATIONS = {
  ...
  "josh jacobs": { verdict: "fade", trend: "falling", trendNote: "CHARGED, UNDER NFL REVIEW, AND GREEN BAY IS PLANNING FOR A SUSPENSION (updated Aug 28 2026). He was formally charged with two misdemeanors out of the May arrest — criminal damage to property and battery — with an initial court appearance set for Nov 17 2026. That is a narrower charge sheet than the arrest allegations, which is the one favourable read available here. NO SUSPENSION HAS BEEN ANNOUNCED and the league review remains open, but Schefter reported on Aug 11 2026 that it is still pending, the Packers\' front office has publicly said it is preparing for the possibility, and outside expectations cluster around six games under the personal conduct policy. THE PROBLEM IS THE SHAPE OF THE RISK, NOT ITS SIZE: a conduct suspension lands at the front of the season with no warning window, so an ADP near 41 is being paid before the availability question resolves. If a ban lands, the Green Bay backfield behind him is the play.", situationFlags: [], riskFlags: ["contract_year", "qb_uncertainty"] },
