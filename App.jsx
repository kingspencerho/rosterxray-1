...
const RECENT_NEWS = {
  ...
  "deebo samuel": "SF (signed Aug 1 2026, 1yr/up to $7M). Re-signed with San Francisco the same day Pearsall went on IR — note the team history is 49ers through 2024, Washington in 2025, then free agent, so older data reading WAS or FA was correct at the time and is now stale. GM John Lynch: the team will 'use him all over the field' — receiver, backfield touches, return duties. 2025 in WAS: 72/727/5 on 99 targets plus 17 carries. The SF room ahead of him is thin (Evans age 32, Kirk calf, Pearsall out), so touch floor beats his ADP, but gadget usage caps target-share ceiling.",
  ...
  "jadarian price": "SEA rookie RB (No. 32 overall) — CONFIRMS the expected role. Maximizing reps across all three offensive units and frequently targeted in passing drills. Seattle is expected to lean on him early with Charbonnet on PUP (ACL, Feb 20 surgery; coach says Week 1 'possible,' analysts project Oct/Nov). Replaces Kenneth Walker III, who left in free agency. Best combination of draft capital, vacated volume and a hurt incumbent among rookie RBs.",
  ...
  "bijan robinson": "ATL — contract HOLD-IN through Aug 2 2026 (reporting to camp and present at every practice, but not practicing) while seeking an extension after leading the NFL with 2,298 all-purpose yards in 2025. A hold-in is not a holdout and both sides expect an amicable deal. Treat as noise, not signal — do not discount his ADP for it.",
