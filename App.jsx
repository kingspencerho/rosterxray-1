...
const SITUATIONS = {
  ...
  "jeremiyah love": { verdict: "TARGET", trend: "rising", trendNote: "Started the preseason opener with the ARI ones, ~75% of snaps over the first three drives, and all 14 touches in the first half (11-58 rushing, 3-14 receiving) with a viral spin-and-hurdle rep. That supersedes the late-July camp read that had Allgeier leading first-team carries. Two live caveats: a first-half ankle twist described as a possible mild lateral sprain, with LaFleur saying he does not think it is serious and the second-half absence reading as precautionary; and the calendar, since pre-Week-3 preseason snaps are evaluation before they are confirmation. Allgeier still took three carries on the opening drive, so the committee is not dead — it has just inverted. No. 3 overall capital behind it.", situationFlags: ["breakout_profile"], riskFlags: ["creeping_committee", "injury_history"] },
