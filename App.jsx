...
const RECENT_NEWS = {
  ...
  "wandale robinson": "TEN. 2025 NYG breakout was real (92/1014/4, 27.8% target share) — first year clearing 700 yards, with genuine downfield usage (27.5% air yards share). Carnell Tate (4th overall pick) is projected to take the outside/vertical work in 2026, capping Robinson's ceiling. Note this is a forecast about a brand-new TEN situation, not an observed role — treat the target-share projection as unconfirmed until camp reporting lands. Verdict: fade is about 2026 role compression and unproven fit, not a historical limitation.",
...
const SITUATIONS = {
  ...
  // slot_only roleCeiling removed Jul 31 2026: the flag contradicted this entry's own
  // evidence. A 27.5% air yards share is not a slot-only usage profile, and the TEN
  // projection is a forecast about a brand-new situation, not an observed role. Keeping
  // a scored -0.35 "limited role" deduction on a projection was the wrong instrument.
  // The role-compression case against him (Tate's arrival) is preserved below.
  "wandale robinson": { verdict: "fade", trend: "falling", trendNote: "2025 NYG breakout was real (92/1014/4 on a 27.8% target share and 27.5% air yards share) — genuine downfield usage, not a slot-only profile. New situation in TEN for 2026: Tate (4th overall) is expected to take outside/downfield work, which compresses Robinson's ceiling on volume he has to re-earn with a new team and QB. Fade is about that compression and the unproven fit, not a pre-existing role limitation.", situationFlags: ["role_compression"], riskFlags: [] },
