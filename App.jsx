...
const RECENT_NEWS = {
  ...
  "jeremiyah love": "High ankle sprain suffered in the preseason opener. Out for the remainder of preseason, with Arizona targeting Week 1 roughly four weeks out.",
  ...
  "george kittle": "Activated off the PUP list ahead of schedule and tracking toward Week 1 availability.",
  ...
  "shedeur sanders": "Cleveland named Deshaun Watson the Week 1 starter on Aug 24 2026. Sanders is the backup.",
  ...
  "tyler allgeier": "Opens 2026 as the Arizona lead back with Jeremiyah Love recovering from a high ankle sprain and Trey Benson a free agent.",
  ...
  "sam laporta": "Hip injury sustained in training camp. Week 1 status unclear as of Aug 26 2026.",
  ...
  "kayshon boutte": "Traded from New England to Houston on Aug 24 2026 for S Jaylen Reed and a 2028 seventh-round pick. He steps into the starting job opposite Nico Collins.",
  ...
  "james conner": "Third on the Arizona depth chart as of Aug 26 2026, behind Jeremiyah Love and Tyler Allgeier.",
  "trey benson": "Arizona moved on from him during the Aug 2026 roster reduction. He is a free agent.",
  "puka nacua": "Working back from a groin injury, not practicing as of Aug 25 2026. Reported as minor.",
  "ashton jeanty": "Sprained ankle confirmed Aug 25 2026, reported as not long-term. Week 1 availability against Miami is unresolved.",
};
...
const SITUATIONS = {
  ...
  "ashton jeanty": { verdict: "hold", trend: "falling", trendNote: "SPRAINED ANKLE, WEEK 1 IN QUESTION (updated Aug 26 2026). ESPN and NFL Network both report a sprain rather than the long-term injury first feared, which is a material upgrade on the initial read. Ankle sprains run one to six weeks depending on grade, and the grade has not been reported, so his availability for the opener against Miami is genuinely open. The workload case is unchanged when he plays. Price him as a back who may miss early games rather than as a clean first-round pick.", situationFlags: [], riskFlags: ["injury_history"] },
  ...
  "tyler allgeier": { verdict: "TARGET", trend: "rising", trendNote: "HE OPENS THE SEASON AS ARIZONA\u0027S LEAD BACK (updated Aug 26 2026). Jeremiyah Love has a high ankle sprain and is targeting Week 1, and Trey Benson is a free agent, so the depth behind Allgeier is a 31-year-old James Conner. He signed 2yr/$12.25M from Atlanta, which clears the Ambiguous Backfield Filter financial gate, and his 2025 profile is the most concentrated short-yardage body in the dataset at 19 green-zone carries on 16 targets. Mike LaFleur arrives from the league top-scoring offense. The bet is touchdown equity while he holds the job, not that he holds it all season.", situationFlags: ["scheme_fit"], riskFlags: ["depth_chart_competition"] },
  ...
  "kayshon boutte": { verdict: "TARGET", trend: "rising", trendNote: "HOUSTON WIDE RECEIVER (updated Aug 26 2026). Houston acquired him from New England on Aug 24 for a safety and a 2028 seventh-round pick, and the move answers the Jayden Higgins ACL. He starts opposite Nico Collins in a room that needs him, which is a larger role than the one he left. His 2025 line is 33-551-6 with 16.7 yards per catch, fifth in the NFL. The open question is target share: Jaylin Noel, Xavier Hutchinson and Tank Dell are all live for the same vacated work, and he joins the offense days before the opener.", situationFlags: ["scheme_fit"], riskFlags: ["depth_chart_competition"] },
  ...
  "shedeur sanders": { verdict: "fade", trend: "falling", trendNote: "HE IS THE CLEVELAND BACKUP (updated Aug 26 2026). Deshaun Watson was named the Week 1 starter on Aug 24, which settles the competition and removes the qb_uncertainty overhang from the Cleveland pass catchers. Sanders carries no projectable role while Watson is upright. His 2025 completion percentage was the lowest among quarterbacks with 200 or more attempts.", situationFlags: [], riskFlags: ["depth_chart_competition"] },
  ...
  "jeremiyah love": { verdict: "hold", trend: "falling", trendNote: "HIGH ANKLE SPRAIN (updated Aug 26 2026). He suffered it in the preseason opener, the same game in which he took roughly 75 percent of first-team snaps and all 14 first-half touches, so the role signal and the injury arrived together. He is out for the rest of the preseason and Arizona is targeting a Week 1 return roughly four weeks from the injury. High ankle sprains commonly linger past their first estimate. The third overall pick keeps the job long-term; the question is when he is on the field, which makes Tyler Allgeier the immediate beneficiary.", situationFlags: ["breakout_profile"], riskFlags: ["injury_history"] },
  ...
  "james conner": { verdict: "fade", trend: "falling", trendNote: "THIRD ON THE ARIZONA DEPTH CHART (updated Aug 26 2026), behind Jeremiyah Love and Tyler Allgeier. He is 31 and returning from the foot injury that ended his 2025 season in Week 3. His 2025 rate stats are strong on a small sample and describe a role he no longer holds, so grade the depth chart rather than the per-game numbers. He has standalone value only if both backs ahead of him are unavailable.", situationFlags: [], riskFlags: ["injury_history", "depth_chart_competition"] },
  "trey benson": { verdict: "fade", trend: "falling", trendNote: "HE IS A FREE AGENT (updated Aug 26 2026). Arizona moved on from him during the roster reduction, so he has no team, no depth chart position and no projectable role until he signs somewhere. Treat any ADP still carried for him as stale. Revisit only if he signs and a path to touches comes with it.", situationFlags: [], riskFlags: ["depth_chart_competition"] },
  "puka nacua": { verdict: "TARGET", trend: "stable", trendNote: "ELITE VOLUME WITH A GROIN INJURY TO MONITOR (updated Aug 26 2026). His 2025 line is 129 receptions in 16 games with a 0.94 usable rate and a 0.06 dud rate, the steadiest first-round profile in the pool and the largest full-PPR premium on the board at roughly 4.0 points per game over half-PPR. He is working back from a groin injury and had not returned to practice as of Aug 25, reported as minor. Confirm he is practicing before drafting him in the first round.", situationFlags: [], riskFlags: ["injury_history"] },
  "george kittle": { verdict: "TARGET", trend: "rising", trendNote: "ACTIVATED OFF THE PUP LIST AND AHEAD OF SCHEDULE (updated Aug 26 2026), with a real path to playing Week 1 after the Achilles tear that ended his 2025 season. His 57 receptions in 11 games is a top-five tight end pace and his price still reflects the injury rather than the recovery. THE PLAYOFF SLATE IS THE WORST IN THE POOL: SF draws LAC, KC and PHI in W15-17 and all three grade tough against tight ends, which is a redraft tiebreaker against him when the alternative is close.", situationFlags: [], riskFlags: ["injury_history"] },
  "sam laporta": { verdict: "hold", trend: "falling", trendNote: "HIP INJURY FROM CAMP, WEEK 1 UNCLEAR (updated Aug 26 2026). His usage when healthy is starter-grade at a 91 percent snap share and 40 receptions in nine games, so the case rests entirely on availability. He is not a safe single-tight-end plan at his current price. Pair him with a second tight end or take a healthier option in the same range.", situationFlags: [], riskFlags: ["injury_history"] },
};
