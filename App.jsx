...
const RECENT_NEWS = {
  "adam randall": "BAL rookie RB, 2026 fifth round out of Clemson, built as a JOKER under new OC Declan Doyle: fullback, tight end, slot and flexed outside. PRESEASON WEEK 3, Aug 28 2026 vs WAS: 5 carries for 25 yards and 3 catches for 45 yards, including a screen he turned into 24 by stiff-arming a defensive back. He shed a tackler in the backfield on his second carry and broke another for a 4-yard gain. HC Jesse Minter afterward called the skill set versatile, said he has learned to be a really physical runner, and credited a really good skill set out of the backfield. He had missed the Week 2 game vs MIN with a minor injury and returned without limitation. Beat reporting has him proven for the 53-man roster. He sits behind Derrick Henry and Justice Hill and competes with Rasheen Ali for the RB3 job. Aug 15 debut vs PHI: team-leading 13 touches, 12 carries, 46 yards, a rushing TD.",
...
const SITUATIONS = {
  "adam randall": { verdict: "DART", trend: "rising", trendNote: "BAL JOKER ROOKIE, fifth round 2026 out of Clemson (updated Aug 30 2026). New OC Declan Doyle deploys him as a multi-position piece, fullback through tight end through slot and flexed outside, so this is a ROLE rather than a depth-chart slot. PRESEASON WEEK 3 IS THE SIGNAL AND IT IS A RECEIVING ONE: Aug 28 2026 vs WAS he went 5-25 on the ground and 3-45 through the air, 15.0 yards per catch, the long a screen he took 24 by stiff-arming a defensive back. Creating after the catch in space is precisely the job the staff described, and per Lens 4 usage after preseason Week 3 is the primary signal and outranks coachspeak. The running answered its own question too: 5.0 per carry, a tackler shed in the backfield and another broken. HC Jesse Minter is on record with FUNCTIONAL language rather than generic praise, calling the skill set versatile, saying he has learned to be a really physical runner and crediting a really good skill set out of the backfield. Lens 4 grades that as signal. He missed the Week 2 game vs MIN with a minor injury and returned unlimited, and beat reporting has him locked to the 53. THE DEPTH CHART IS STILL THE CONSTRAINT: Derrick Henry and Justice Hill are ahead of him and Rasheen Ali competes for the same RB3 job, so there is no standalone weekly volume at full health. The price buys the Henry contingency plus a gadget role that can spike without it. STACK CAUTION SPECIFIC TO THIS APP: he is a rookie with no prior NFL season, so he clears neither the Elite Receiving Back nor the Real Receiving Role tier and earns NO receiving-back stack credit, however his camp receiving line reads. Grade a Lamar loop containing him as the QB plus its pass catchers and treat Randall as a same-team dart on top. Baltimore W17 at CIN is the strongest of his three playoff environments. Confidence MEDIUM on the role and SPECULATIVE on weekly output: gadget usage is the least projectable role in football, and all of the above was earned against backup defenses in August.", situationFlags: ["role_dependent", "scheme_fit"], riskFlags: ["depth_chart_competition"] },
